...
INSERT INTO `pjiang_litfit_attire_list` (`id`, `type`, `subtype`, `subsubtype`, `pattern`, `fit`, `weight`, `formality`) VALUES
(1, 'Top', 'Jacket', 'Blazer/Suit', 'None', 'Form-fitting', 'Medium', 5),
(2, 'Top', 'Jacket', 'Bomber', 'Horizontal Stripes', 'Regular', 'Light', 2),
(3, 'Top', 'Jacket', 'Denim', 'Vertical Stripes', 'Oversized', 'Medium', 1),
...
(23, 'Bottom', 'Pants', 'Cargo', 'None', 'Slim', '', 1),
(24, 'Bottom', 'Pants', 'Chinos', 'Horizontal Stripes', 'Regular', '', 3),
(25, 'Bottom', 'Pants', 'Corduroy', 'Vertical Stripes', 'Relaxed', '', 2),
